"""Pull Request Review Agent - Main Agent Implementation."""
...
class PrReviewAgentAgent:
    ...
    def __init__(self):
        ...
        self.diff_analysis_enabled = True
        self.security_scanning_enabled = True
        self.performance_review_enabled = True
        self.style_enforcement_enabled = True
        self.coverage_analysis_enabled = True
        self._tool_dispatch = {
            "analyze_diff": self.tools.analyze_diff,
            "check_security": self.tools.check_security,
            "check_performance": self.tools.check_performance,
            "check_test_coverage": self.tools.check_test_coverage,
            "post_review_comment": self.tools.post_review_comment,
            "approve_or_request_changes": self.tools.approve_or_request_changes,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['diff_analysis', 'security_scanning', 'performance_review', 'style_enforcement', 'coverage_analysis'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "approve_or_request_changes": ['approve', 'or', 'request', 'changes'],
        }
